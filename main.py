...
# Grammar testlari (O'z joyida qoladi)
A1_QUESTIONS = [{"q": "1. I ... a student.", "options": ["is", "am", "are", "be"], "correct": 1}]
A2_QUESTIONS = [{"q": "1. If it rains, I ... at home.", "options": ["stay", "will stay", "stayed", "staying"], "correct": 1}]
B1_QUESTIONS = [{"q": "1. By this time next year, I ... my studies.", "options": ["will finish", "will have finished", "finish", "finished"], "correct": 1}]
B2_QUESTIONS = [{"q": "1. Much ... known about the ancient civilization.", "options": ["are", "is", "have", "were"], "correct": 1}]
C1_QUESTIONS = [{"q": "1. ... be that as it may, we must proceed with the plan.", "options": ["Let", "May", "Should", "Would"], "correct": 0}]

# 10 ta IELTS Reading Mock uchun 100% noyob matnlar va 20 tadan mukammal savollar bazasi
READING_MOCKS = {
    1: {
